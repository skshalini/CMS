...
<head>
 ...
 <script>
         $(function() {
            ...
            $( "#inlineFormInputName1" ).autocomplete({
               source: libraryBooks
            });
         });
            ...
            <div class="card-body">
                ...
                <form method="post" action="university.php" > 
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <input name="author" type="text" class="form-control" id="inlineFormInputName2" placeholder="Ex: 'J. R. R. Tolkien'" />
                      </div>
                    </div>
                    <div class="form-group row">
                      <div class="col-sm-10">
            ...
            <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordion">
              <div class="card-body">
                <div class="jumbotron">
                    ...
                    <p class="lead">
                    <form method="post" action="university.php">
                      <a class="btn btn-primary btn-lg" href="#" name="mevlana" role="button">Learn more</a>
                  </form>
                    </p>
                  </div>
              </div>
              <div class="jumbotron">
                ...
                <p class="lead">
                <form method="post" action="university.php">
                  <a class="btn btn-primary btn-lg" href="#" name="erasmus" role="button">Learn more</a>
                  </form>
                </p>
              </div>
              <div class="jumbotron">
                ...
                <p class="lead">
                <form method="post" action="university.php">
                  <a class="btn btn-primary btn-lg" href="#"  name="farabi" role="button">Learn more</a>
                  </form>
                </p>
              </div>
            </div>
