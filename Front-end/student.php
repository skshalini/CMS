...
<body>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      ...
      <li class="nav-item">
          <a class="nav-link" id="" data-toggle=""  href="student_detail.php" aria-controls="" aria-selected="">Student Detail</a>
        </li>

        <li class="nav-item">
          <a class="nav-link" id="" data-toggle=""  href="marks_detail.php" aria-controls="" aria-selected="">Marks Detail</a>
        </li>
...
<!------Single user past course detail view ------->
...
<!-----Single student exam result view------>
...
<!----Single Student course view---->
        ...
        <?php 
            ...
            $query2 = "SELECT * FROM student WHERE student_id = '$st_id'";
            $results2 = mysqli_query($db, $query2);  ?>

                  <tr>
                  <td scope="row"><?php echo $student['course_code'] ?></td>
                  <td scope="row"><?php echo $student['grade'] ?></td> 
                  <td scope="row"><?php echo $student['advisor_name'] ?></td> 
                  <td scope="row"><?php echo $student['course_type'] ?></td> 
                 </tr>
            </tbody>
          </table>
        </div>

<!------List of all course selection view----->
