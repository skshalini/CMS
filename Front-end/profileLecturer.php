      ...
      <div class="tab-content" id="myTabContent">
        ...
        <div class="tab-pane fade" id="students" role="tabpanel" aria-labelledby="students-tab">
          <?php
            ...
            <ul class="nav nav-tabs">
                <li class="nav-item">
                    <a class="nav-link" id="undergraduate-tab" data-toggle="tab"  href="#undergraduate" aria-controls="undergraduate">Undergraduate</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="graduate-tab" data-toggle="tab"  href="#graduate" aria-controls="graduate">Graduation</a>
                </li>
                <li class="nav-item">
            ...
            <div class="tab-pane fade" id="undergraduate" role="tabpanel" aria-labelledby="undergraduate-tab">
                <table class="table table-striped">
                      ...
                      <?php 
                        ...
                        $query2 = "SELECT * FROM student WHERE advisor_name = '$l_name' and degree = 'Undergraduate'";
                        $results2 = mysqli_query($db, $query2);
                        while($row2 = mysqli_fetch_array($results2))
                        { ?>
            ...
            <div class="tab-pane fade" id="graduate" role="tabpanel" aria-labelledby="graduate-tab">
                <table class="table table-striped">
                      ...
                      <?php 
                        ...
                        $query2 = "SELECT * FROM student WHERE advisor_name = '$l_name' and degree = 'Graduate'";
                        $results2 = mysqli_query($db, $query2);
                        while($row2 = mysqli_fetch_array($results2))
                        { ?>
        ...
        <div class="tab-pane fade" id="myprofile" role="tabpanel" aria-labelledby="myprofile-tab">
          <div class="card" style="width: 18rem;">
            <img class="card-img-top" src="college-professor-1.jpg" alt="Card image cap">
            <div class="card-body">
              <?php
